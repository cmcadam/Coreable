...
urlpatterns = [
    ...
    url(r'^connectivity/', views.connectivity_review, name='connectivity_review'),
    url(r'^problem-solving-openness/', views.problem_solving_openness_review, name='problem_solving_openness_review'),
